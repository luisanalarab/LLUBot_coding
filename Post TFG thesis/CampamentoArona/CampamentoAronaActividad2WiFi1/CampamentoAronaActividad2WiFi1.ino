...
void loop() {
  ...
  if (sensorVal == 0) {
    ...
    client.println("        .buttonright {background-color: white; border-radius: 12px; border: none; color: #7c05a3; padding: 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 25px; position: relative; left: 15px;}");
    ...
    client.println("        .buttonleft {background-color: white; border-radius: 12px; border: none; color: #7c05a3; padding: 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 25px; position: relative; left: -15px;}");
    client.println("        .num {padding: 30px; text-decoration: none; display: inline-block; width: 30px; font-size: 25px}");
    ...
    client.println("      <div class= 'buttonforward'> Avanzar <input class='num' type='text' id='input1'/> pasos <br></br><button class= 'buttongo'><a id='a1' href='' color: white> Go! </a></button></div><br></br>");
    client.println("      <div class= 'buttonleft'> Girar <input class='num' type='text' id='input4'/> pasos a la izquierda <br></br><button class= 'buttongo'><a id='a4' href=''> Go! </a></button></div>");
    client.println("      <div class= 'buttonright'> Girar <input class='num' type='text' id='input3'/> pasos a la derecha <br></br><button class= 'buttongo'><a id='a3' href=''> Go! </a></button></div><br></br>");
    client.println("      <div class= 'buttondown'> Retroceder <input class='num' type='text' id='input2'/> pasos <br></br><button class= 'buttongo'><a id='a2' href=''> Go! </a></button></div><br></br><br></br>");
    ...
    client.println("        <p> Di&aacutemetro de las ruedas de un LLUBot = 3,1 cm. </p>");
    ...
    client.println("        <p> El motor de los LLUBots tiene 256 pasos para realizar una vuelta completa y cada &oacuterden de movimiento es 1/8 paso, llamado micropaso, por lo que, &iquestcu&aacutentos micropasos hacen falta para que d&eacute una vuelta entera la rueda? </p>");
    ...
    client.println("        <p> Si ya sabemos cu&aacutentos micropasos son 1 cm, sabemos la relaci&oacuten de giro. Y si sabemos que el per&iacutemetro del centro de giro de nuestro LLUBot es como vemos arriba son los 360&deg totales de giro, y b = 16 cm... </p>");
